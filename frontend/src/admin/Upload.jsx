...
const Upload = ({ onClose, fetchAllRoom }) => {
  ...
  const handleOnSubmit = async (e) => {
    e.preventDefault();
    const fetchdata = await fetch(ApiList.upload_room.url, {
      method: ApiList.upload_room.method,
      credentials: "include",
      headers: {
    ...
    >
      ...
      <div className="flex gap-2 items-center justify-center ">
        {data.picture[0] ? (
          ...
          <p className="text-primaryColor ">* Please upload product image</p>
        )}
      </div>
